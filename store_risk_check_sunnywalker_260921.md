# store_risk_check — SunnyWalker `[swift-app]`  (260921)
...
- [ ] !!!, **寫死字級(文字範圍≤34) ×1（Dynamic Type 易破版/被退）**  `GUI(4.1/破版)`
  - 位置/影響：SunnyWalker/Views/Alarm/AlarmListView.swift:672
  - 修法：SwiftUI 改用語意字體 .font(.body/.headline…) 或 @ScaledMetric 讓字隨系統縮放；

## P2 — 參考

- [ ] **寫死大字級(>34) ×2（多為裝飾性 emoji/大標，確認是否該固定）**  `GUI(4.1/破版)`
  - 位置/影響：KidBrowser/KidBrowser/HomeView.swift:105(size 52); KidBrowser/KidBrowser/HomeView.swift:108(size 46)
